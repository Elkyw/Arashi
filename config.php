<?php
/*
 This is the configuration file for the moz accessID and secretkey for Arashi's bloggers view scan.
 ...
 idk im not going to put my own access id and secret key here just for some reasons 
 */

$accessID = "put your access id in between the quotes"; // right here you put your access ID
